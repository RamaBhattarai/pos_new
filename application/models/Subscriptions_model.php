...
class Subscriptions_model extends CI_Model
{
    ...
    var $column_order = array(null, 'pos_invoices.tid', 'pos_customers.name', 'pos_invoices.invoicedate', 'pos_invoices.total', 'pos_invoices.status', null, null);
    ...
    {
        $this->db->select('pos_invoices.id,pos_invoices.tid,pos_invoices.invoicedate,pos_invoices.invoiceduedate,pos_invoices.total,pos_invoices.status,pos_invoices.i_class,pos_customers.name');
        $this->db->from($this->table);
