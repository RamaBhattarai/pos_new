<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Purchase Entry') ?> <a
                        href="<?php echo base_url('purchase/create_entry') ?>"
        ...
        $(document).ready(function () {
            ...
            function draw_data(start_date = '', end_date = '') {
                $('#po').DataTable({
                    ...
                    'order': [],
                    'ajax': {
                        'url': "<?php echo site_url('purchase/ajax_entry_list')?>",
                        'type': 'POST',
                        'data': {
...
$(document).on('click', "#send", function (e) {
    e.preventDefault();
    var acturl = 'transactions/cancelinvoiceentry';
    cancelBill(acturl);
});
