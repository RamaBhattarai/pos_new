                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card-title">
                                ...
                                <small class="text-muted mt-1" id="payment-method-info">Select a payment method to see linked account</small>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // Update account balance when payment method changes
        $('#p_method').change(function() {
            ...
            if (accountName) {
                $('#payment-method-info').text('Account: ' + accountName);
                $('#payment-method-info').removeClass('text-muted').addClass('text-info');
            } else {
                $('#payment-method-info').text('Select a payment method to see linked account');
                $('#payment-method-info').removeClass('text-info').addClass('text-muted');
            }
            
            console.log('Payment method changed - Account:', accountName);
        });
        
        // Initialize payment method info on page load
        $('#p_method').trigger('change');
