...
<?php if ($product_variations) {
    ...
    <table class="table table-striped table-bordered">
        ...
        foreach ($product_variations as $product_variation) {
            $variant_display = $product_variation['variant_name'] ? $product_variation['variant_name'] : 'N/A';
            ...
            echo '<tr>
                    ...
                    <td>Price: ' . amountExchange($product_variation['product_price'], 0, $this->aauth->get_user()->loc) . '</td>
                  </tr>';
        } ?>
        </tbody>
    </table>
