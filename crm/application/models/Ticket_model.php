...
class Ticket_model extends CI_Model
{
    ...
    public function thread_list($id)
    {
        ...
        $this->db->join('pos_tickets_th', 'pos_tickets.id=pos_tickets_th.tid', 'left');
        ...
        $this->db->where('pos_tickets.cid', $this->session->userdata('user_details')[0]->cid);
    ...
    {
        $this->db->select('pos_tickets.*, pos_customers.name');
        $this->db->from('pos_tickets');
    ...
    function addreply($thread_id, $message, $filename)
    {
        ...
        if ($valid['cid'] == $this->session->userdata('user_details')[0]->cid) {
            ...
            if (isset($multi[0])) return $this->db->insert_batch('pos_tickets_th', $multi);
    ...
    function addticket($subject, $message, $filename)
    {
        ...
        $this->db->insert('pos_tickets', $data);
