...
class Subscriptions_model extends CI_Model
{
    ...
    public function invoice_details($id)
    {
        ...
        $this->db->select('pos_invoices.*,pos_invoices.id AS iid,pos_customers.*,pos_customers.id AS cid,pos_terms.id AS termid,pos_terms.title AS termtit,pos_terms.terms AS terms');
